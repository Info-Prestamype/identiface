                ...
                */
                ...
                for (let i = 0; i < this.contours.size(); ++i) {
                    ...
                    if(area > 22000) {
                        ...
                        console.log('width:'+ rect.width, this.trackWindow.width-80)
                        console.log('height:'+ rect.height, this.trackWindow.height-80)

                        if(rect.width < this.trackWindow.width-80 &&
                            rect.height < this.trackWindow.height-20  
                        ){
