        ...
        methods: {
            ...
            recognition(){
                ...
                */
                        ...
                        if(rect.width < this.trackWindow.width-1 &&
                            ...
                            if(this.faceClass !== undefined){
                                ...
                                for (let i=0;i<this.faces.size();i++) {
                                    ...
                                    if(face.y <= this.trackWindow.height*0.6 && face.x + face.width<=this.trackWindow.width*0.3){
                ...
                cv.rectangle(this.roi, new cv.Point(0, this.trackWindow.height*0.6), new cv.Point(this.trackWindow.width*0.3,0), this.colorRec, 2);
