        ...
        methods: {
            ...
            async setupCV() {
                ...
                if (this.frame == undefined) {
                    ...
                    this.frame = await new cv.Mat(this.width, this.height, cv.CV_8UC4);
            ...
            recognition(){
                if(!this.inProcess){
                    ...
                    this.trackWindow = new cv.Rect(this.width*0.2, this.height*0.2, this.width*0.8-this.width*0.2,this.height*0.8-this.height*0.2);
